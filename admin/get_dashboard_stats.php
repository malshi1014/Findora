...
$total_suspicious_reports = getCount($conn, "SELECT COUNT(*) AS total FROM suspicious_report");
...
$pending_suspicious_reports = getCount($conn, "SELECT COUNT(*) AS total FROM suspicious_report WHERE status = 'pending'");
...
echo json_encode(array(
    ...
    "stats" => array(
        ...
        "total_suspicious_reports" => $total_suspicious_reports,
        "pending_lost_reports" => $pending_lost_reports,
        "pending_found_reports" => $pending_found_reports,
        "pending_suspicious_reports" => $pending_suspicious_reports,
