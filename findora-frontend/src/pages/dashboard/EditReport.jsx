          ...
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="p-8 bg-white/30 backdrop-blur-xl rounded-[2rem] border border-white/40 shadow-xl shadow-blue-600/5">
              <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                <div>
                  <span className="inline-block self-start px-4 py-1.5 bg-blue-600/10 rounded-full text-blue-700 text-sm font-semibold uppercase tracking-[0.24em]">Editing Report #{id}</span>
                  <h1 className="mt-4 text-3xl font-bold text-slate-950">Edit Report</h1>
                ...
                <div className="flex items-center gap-3 rounded-full bg-white/40 backdrop-blur px-4 py-3 shadow-sm shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Editing Report</p>
                  </div>
                </div>
              </div>
            </div>
