...
function ReportSuspiciousItem() {
  ...
  const validateForm = () => {
    ...
    if (foundDate && foundDate > today) errors.foundDate = "Found date cannot be in the future";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const toTimeAMPM = formatManualTime(
        timeTo,
        timeToPeriod
      );
      ...
      if (data.status === "success") {
        ...
        navigate("/shop-owner/my-reports");
      } else {
        setError(
          data.error
          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-600">
                Provide details about a suspicious item received by your shop. Adding photos and identifying marks will help the admin team review the report.
              </p>
            </div>
            ...
            <div className="grid gap-6">
              <label className="block">
                ...
                <input
                  ...
                  placeholder="Example: Suspicious black iPhone 11"
              ...
              <label className="block">
                ...
                <input
                  ...
                  placeholder="Where was the item received or found?"
                  className={`mt-3 w-full rounded-3xl border ${
      ...
      <option value="PM">PM</option>
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  rows="4"
                  placeholder="Provide details about the item, its condition, and why it appears suspicious."
                  className={`mt-3 w-full rounded-3xl border ${
