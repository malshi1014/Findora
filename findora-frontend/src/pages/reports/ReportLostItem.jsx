            ...
            <div className="p-8 bg-white/30 backdrop-blur-xl rounded-[2rem] border border-white/40 shadow-xl shadow-blue-600/5">
              <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                <div>
                  ...
                  <h1 className="mt-4 text-3xl font-bold text-slate-950">Report Lost Item</h1>
                  <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600">Share the details of your lost item so our community can help you recover it quickly.</p>
                </div>
