...
function ReportMissingPerson() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!fullName || !age || !gender || !lastSeenLocation || !lastSeenDate || !description) {
            ...
            <div className="p-8 bg-white/30 backdrop-blur-xl rounded-[2rem] border border-white/40 shadow-xl shadow-blue-600/5">
              <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                <div>
                  ...
                  <h1 className="mt-4 text-3xl font-bold text-slate-950">Report Missing Person</h1>
                  <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600">Help our community find a missing person by providing accurate details to aid search efforts.</p>
                </div>
            ...
            <div className="p-10 bg-white/30 backdrop-blur-xl rounded-[2rem] border border-white/40 shadow-xl shadow-blue-600/5">
              <form onSubmit={handleSubmit} className="space-y-9">
                ...
                <div className="grid gap-8">
                  <div className="grid gap-4 lg:grid-cols-[2fr_1fr_1.15fr]">
                    <label className="block">
                      <span className="text-sm font-semibold text-slate-700">Full Name</span>
                      <input type="text" value={fullName} onChange={(e) => setFullName(e.target.value)} placeholder="Full name of the person"
                  ...
                  <div className="grid gap-8 lg:grid-cols-2">
                    <label className="block">
                      ...
                      <input type="text" value={lastSeenLocation} onChange={(e) => setLastSeenLocation(e.target.value)} placeholder="Where were they last seen?"
                        className="mt-3 w-full rounded-3xl border border-white/40 bg-white/40 backdrop-blur px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-100" />
                    </label>
                    <label className="block">
                  ...
                  <label className="block">
                    ...
                    <textarea value={description} onChange={(e) => setDescription(e.target.value)} rows="4" placeholder="Provide details like height, weight, clothing, physical features, etc."
