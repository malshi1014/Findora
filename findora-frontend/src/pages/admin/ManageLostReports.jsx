...
import { Search, Filter, RefreshCw, Eye, EyeOff, Check, X, AlertTriangle } from "lucide-react";
...
function ManageLostReports() {
  ...
  const stats = [
    ...
    },
    {
      ...
      colors: { text: "text-indigo-600", bg: "bg-indigo-50/60", border: "border-indigo-100/70" },
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500 max-w-2xl">
                Review, approve, reject and monitor all lost item reports submitted by users.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <button
                onClick={() => fetchLostReports()}
                className="flex items-center justify-center gap-1.5 rounded-full border border-slate-200 bg-white px-5 py-2.5 text-xs font-semibold text-slate-650 hover:bg-slate-50 text-slate-700 transition-all"
              >
        ...
        <section className="rounded-3xl border border-slate-200/50 bg-white/80 p-5 md:p-6 shadow-sm backdrop-blur-md">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 pb-5">
            ...
            <p className="text-xs text-slate-400 font-medium">
              Showing {filteredReports.length} of {lostReports.length} lost reports
            </p>
          </div>
            ...
            <table className="w-full min-w-[1000px] border-collapse text-left text-xs">
              <thead>
                <tr>
                  ...
                  <th className="pb-4 pr-4 font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100">Reported By</th>
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredReports.length === 0 ? (
                  <tr>
                    <td
                      colSpan="7"
                      className="py-12 text-center text-sm text-slate-450 text-slate-400"
                    >
                        ...
                        <td className="py-4 pr-4">
                          <div className="flex items-center gap-3.5 max-w-sm">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="mt-0.5 line-clamp-1 text-[10px] text-slate-450 text-slate-400">
                                {report.description}
                              </p>
                            </div>
                          </div>
