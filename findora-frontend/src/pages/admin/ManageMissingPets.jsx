          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500 max-w-2xl">
                Review, approve, reject and monitor all missing pet case reports.
              </p>
            </div>
        ...
        <section className="rounded-3xl border border-slate-200/50 bg-white/80 p-5 md:p-6 shadow-sm backdrop-blur-md">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 pb-5">
            ...
            <p className="text-xs text-slate-400 font-medium">
              Showing {filteredReports.length} of {petReports.length} cases
            </p>
          </div>
          ...
          <div className="mt-5 overflow-x-auto">
            <table className="w-full min-w-[1050px] border-collapse text-left text-xs">
              <thead>
                <tr>
                  <th className="pb-4 font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100">Pet Details</th>
                  <th className="pb-4 pr-4 font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100">Post ID</th>
                  <th className="pb-4 pr-4 font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100">Category</th>
                  ...
                  <th className="pb-4 pr-4 font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100">Lost Date & Time</th>
                  ...
                  filteredReports.map((report) => {
                    ...
                    return (
                      ...
                      >
                        <td className="py-4 pr-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="mt-0.5 line-clamp-1 text-[9px] text-slate-450 text-slate-400 max-w-[180px]">
                        ...
                        <td className="py-4 pr-4 text-slate-700 font-semibold">
