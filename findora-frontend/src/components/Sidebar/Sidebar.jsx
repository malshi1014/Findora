  ...
  return (
    <aside className="flex h-screen w-64 shrink-0 flex-col border-r border-slate-200 bg-white/90 px-4 py-6 shadow-sm backdrop-blur">
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto">
        <Link to="/dashboard" className={linkClass("/dashboard", true)}>
        ...
        <div className="mt-6 border-t border-slate-200 pt-4">
          ...
          <Link
            ...
            className={linkClass("/dashboard/report-lost")}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <circle
                cx="11"
          ...
          <Link
            ...
            className={linkClass("/dashboard/report-found")}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path
          ...
          <Link
            to="/dashboard/report-person"
            className={linkClass("/dashboard/report-person")}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <circle
                cx="12"
          ...
          <Link
            to="/dashboard/report-pet"
            className={linkClass("/dashboard/report-pet")}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <circle
                cx="7"
        ...
        <div className="mt-6 border-t border-slate-200 pt-4">
          ...
          <Link
            ...
            className={linkClass("/dashboard/my-reports", false, [
          ...
          <Link
            ...
            className={linkClass("/dashboard/matches")}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path
                d="M7 7H17M7 17H17"
        ...
        <div className="mt-6 border-t border-slate-200 pt-4">
          ...
          <Link
            ...
            className={linkClass("/dashboard/donation")}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path
          ...
          <Link
            to="/dashboard/reward"
            className={linkClass("/dashboard/reward")}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <circle
                cx="12"
