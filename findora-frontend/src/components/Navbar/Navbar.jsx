    ...
    <nav className="w-full bg-white shadow-sm sticky top-0 z-50">
      <div className="w-full px-6 py-2 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-white/30 backdrop-blur-sm border border-white/20 flex items-center justify-center overflow-hidden">
            <img src={logo} alt="Findora Logo" className="w-8 h-8 object-contain" />
          </div>
        ...
        {hideAuth ? (
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="bg-red-400 text-white px-4 py-1.5 rounded-lg text-sm font-medium font-['Inter'] hover:bg-red-500 transition"
            >
              Logout
            </button>
          </div>
